...
from utils import *
from PharmFinger import Pharm2D, MACCS 
...
def FitModel(dataset_file,splitter_type):
    ...
    best_rf, best_rf_hyperparams, all_rf_results = optimizer.hyperparam_search(
        ...
        metric=metric,logdir='opt_model_CAMK2B_%s'%type_split)
    filename = 'finalized_model_CAMK2B_%s.sav'%type_split
    print(type_split)
...
if __name__ == "__main__": 
    dataset_file = '../../../data/pki/CAMK2B_pki.csv'
